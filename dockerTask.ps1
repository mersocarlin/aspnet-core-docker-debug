...
.PARAMETER Clean
Removes the image aspnet-core-docker-debug and kills all containers based on that image.
...
Build a Docker image named aspnet-core-docker-debug
#>
...
$imageName="aspnet-core-docker-debug"
$projectName="aspnetcoredockerdebug"
$serviceName="aspnet-core-docker-debug"
